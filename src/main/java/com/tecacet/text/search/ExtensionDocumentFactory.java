...
public class ExtensionDocumentFactory implements DocumentFactory {
    ...
    public ExtensionDocumentFactory(String propertiesFile) throws IOException, DocumentHandlerException {
    ...
    public Document getDocument(File file) throws DocumentHandlerException {
        ...
        Field pathField = new StringField(IndexConstants.PATH_FIELD, file.getPath(), Field.Store.YES);
        document.add(pathField);

        // Add the last modified date of the file a field named "modified". Use
        // a field that is indexed but don't tokenize the field into words.
        document.add(new LongField(IndexConstants.MODIFIED_FIELD, file.lastModified(), Field.Store.NO));
