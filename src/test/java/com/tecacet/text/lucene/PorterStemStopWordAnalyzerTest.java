...
public class PorterStemStopWordAnalyzerTest {
	...
	public void testPorterStemStopWordAnalyzer() throws IOException {
		String[] expected = { "collect", "intellig", "smart", "action", "web",
				"2.0" };

		List<String> words = Files.asCharSource(
				new File("testfiles/stopwords.txt"), Charsets.UTF_8)
				.readLines();
		PorterStemStopWordAnalyzer analyzer = new PorterStemStopWordAnalyzer(
				words);
