...
public class ExtensionDocumentHandlerFactoryTest {
    ...
    @Test
    public void testGetDocument() throws IOException, DocumentHandlerException {

        ExtensionDocumentHandlerFactory handlerFactory = new ExtensionDocumentHandlerFactory("document.factory.properties");
        DocumentHandler handler = handlerFactory.getHandlerForExtension("doc");
        assertEquals("com.tecacet.text.search.handler.MicrosoftTextHandler", handler.getClass().getName());
        ...
        assertEquals("com.tecacet.text.search.handler.HTMLHandler", handler.getClass().getName());
        handler = handlerFactory.getHandlerForExtension("htm");
        assertEquals("com.tecacet.text.search.handler.HTMLHandler", handler.getClass().getName());

        handler = handlerFactory.getHandlerForExtension("rtf");
        assertEquals("com.tecacet.text.search.handler.RTFDocumentHandler", handler.getClass().getName());
    }
